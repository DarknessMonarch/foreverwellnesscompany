  ...
  return (
    <div className={styles.info}>
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.bulletList}>
          <li>Email: foreverwellnesscompany@gmail.com</li>
      ...
      <div className={styles.section}>
        ...
        <p>
          ForeverWellnessCompany reserves the right to make exceptions to this return policy on a case-by-case basis at our sole discretion. Such exceptions do not constitute a waiver of this policy or create any obligation for future exceptions. Any exceptions must be approved in writing by Company management.
        </p>
      </div>
      ...
      <div className={styles.section}>
        <h2>15. Compliance with Kenyan Consumer Protection Laws</h2>
        <p>
      ...
      <div className={styles.section}>
        <h2>16. Contact Information and Dispute Resolution</h2>
        <p>
        ...
        <ul className={styles.bulletList}>
          ...
          <li><strong>Physical Address:</strong> ForeverWellnessCompany Ltd., Nairobi, Kenya 00100</li>
      ...
      <div className={styles.section}>
        ...
        <p>
          This Refund and Return Policy is effective immediately. ForeverWellnessCompany reserves the right to modify this policy at any time. Material changes will be posted on our website with updated effective dates. Continued use of our services following policy modifications constitutes acceptance of the updated policy.
        </p>
      </div>
    </div>
  );
